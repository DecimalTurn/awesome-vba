...
* [⭐][a_all] - All applications
* <picture><source media="(prefers-color-scheme: dark)" srcset="./resources/WordLogo.png"><source media="(prefers-color-scheme: light)" srcset="./resources/WordLogo.png"><img alt="Word" title="Word" src="./resources/WordLogo.png" height="18px" align="center"></picture> - Word
* [📊][a_xl] - Excel
* [🅰️][a_ac] - Access
* [📧][a_ol] - Outlook
* [🎞️][a_pp] - Powerpoint
...
* [🖼][p_win][📊][a_xl]<picture><source media="(prefers-color-scheme: dark)" srcset="./resources/WordLogo.png"><source media="(prefers-color-scheme: light)" srcset="./resources/WordLogo.png"><img alt="Word" title="Word" src="./resources/WordLogo.png" height="18px" align="center"></picture>[🔒][o_pass] - [RibbonX](https://www.andypope.info/vba/ribboneditor_2010.htm) - AndyPope's Visual Ribbon Editor.
